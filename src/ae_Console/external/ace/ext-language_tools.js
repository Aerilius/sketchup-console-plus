...
(function() {
    ...
    this.showDocTooltip = function(item) {
        ...
        if (!tooltipNode.parentNode || tooltipNode.parentNode != document.body) // PATCH: In IE8, tooltipNode would default to have HTMLDocument as parent and not display. Make sure it is appended to body.
